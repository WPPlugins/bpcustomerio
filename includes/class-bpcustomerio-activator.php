...
class Bpcustomerio_Activator {
	...
	public static function activate() {
                if( !in_array( 'buddypress/class-buddypress.php',apply_filters('active_plugins',get_option('active_plugins'))) && !is_plugin_active_for_network( 'buddypress/class-buddypress.php' )   ) { 
